    ...
    execute: function () {
      ...
      _export("PlayerManagerExample", PlayerManagerExample = (_dec = ccclass('PlayerManagerExample'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Button), _dec6 = property(Button), _dec7 = property(Button), _dec8 = property(Button), _dec9 = property(Button), _dec(_class = (_class2 = class PlayerManagerExample extends Component {
        ...
        updateUI() {
          ...
          var data = this._playerManager.playerData;
        ...
        onWechatLoginClick() {
          ...
          return _asyncToGenerator(function* () {
            if (yield _this._playerManager.wechatLogin()) {
              console.log('微信登录成功');
            } else {
              console.log('微信登录失败');
            }
        ...
        simulateCarUpgrade() {
          var carId = this._playerManager.playerData.currentCar;
          var upgradeCost = 500;

          if (this._playerManager.spendMoney(upgradeCost)) {
            // 随机升级一个部件
            var parts = ['engine', 'tires', 'suspension', 'nitro'];
        ...
        exportPlayerData() {
          var jsonData = this._playerManager.exportPlayerData();
...
//# sourceMappingURL=ab16ed11c9a15ffe23be11384ddcb0f67483a20e.js.map