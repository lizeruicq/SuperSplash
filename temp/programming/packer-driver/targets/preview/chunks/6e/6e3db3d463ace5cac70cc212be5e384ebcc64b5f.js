    ...
    execute: function () {
      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(ProgressBar), _dec7 = property(Label), _dec8 = property(Button), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Button), _dec12 = property(Button), _dec13 = property(_crd && GameHUD === void 0 ? (_reportPossibleCrUseOfGameHUD({
        ...
        start() {
          ...
          (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
            error: Error()
          }), SoundManager) : SoundManager).instance.playSoundEffect("battlebgm1");
          this.initializeGame();
        ...
        returnToLevelSelect() {
          ...
          (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
            error: Error()
          }), SoundManager) : SoundManager).instance.stopbattleBGM();
          (_crd && SoundManager === void 0 ? (_reportPossibleCrUseOfSoundManager({
            error: Error()
          }), SoundManager) : SoundManager).instance.playBGM();
        }
        /**
         * 计算游戏结果数据
         * @param isVictory 是否胜利
        ...
        fireBullet(bulletPrefab, position, direction, shooterId, weaponType) {
          ...
          if (weaponType === (_crd && WeaponType === void 0 ? (_reportPossibleCrUseOfWeaponType({
            ...
            // 定义四个方向：上、右、下、左
            var directions = [new Vec2(0, 1), // 上
            new Vec2(1, 0), // 右
            new Vec2(0, -1), // 下
            new Vec2(-1, 0), // 左
            new Vec2(-1, -1), new Vec2(1, 1), new Vec2(-1, 1), new Vec2(1, -1)]; // 为每个方向创建一个子弹
...
//# sourceMappingURL=6e3db3d463ace5cac70cc212be5e384ebcc64b5f.js.map