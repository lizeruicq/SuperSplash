    ...
    execute: function () {
      ...
      _export("HealthBarUI", HealthBarUI = (_dec = ccclass('HealthBarUI'), _dec(_class = (_class2 = class HealthBarUI extends Component {
        ...
        separateFromParent() {
          ...
          const currentWorldPos = this.node.worldPosition; // 将血条移动到Canvas下
        ...
        updatePosition() {
          // 获取AI车辆的世界位置
          const targetWorldPos = this.targetNode.worldPosition; // 设置血条位置（在AI车辆上方）
...
//# sourceMappingURL=26c36b18bd4a3ff52ca03e2c561f5c664b8a98dd.js.map